...
union YYSTYPE
{
#line 36 "gramatica.y" /* yacc.c:355  */
 char *str; int valor;
...
{
  "$end", "error", "$undefined", "IFX", "ELSE", "numero", "operador",
  "atribuidor", "alphanumerico", "argumento", "logico", "ask",
  "quebra_linha", "equals", "IF", "THEN", "AP", "FP", "$accept",
  "programa", "condicao", "ifthenelse", "expr", "func", YY_NULLPTR
};
#endif
...
{
      -6,     6,    -6,    -6,    -4,    10,    -5,     7,    12,    19,
      -4,    -6,     2,    26,    -4,    -6,    35,    -4,     3,    -6,
      -6,    -6,    -4,    41,    -6,    -6,    -6,    30,    -4,    -4,
      36,    42,    -6,    47,    -6,    38,    17,    -6,    24,    -6,
      37,    28,    -4,    39,    40,    -4,    34,    43,    45,    -6,
      -6,    -4,    46,    -6
};
...
{
       7,     0,     1,    14,     0,    15,     0,     0,     0,     0,
       0,    15,     0,     0,     0,    18,     0,     0,     0,     4,
       2,     3,     0,    15,    13,     5,    16,     0,     0,     0,
       0,     0,     8,     0,     6,     0,     0,    17,     0,     9,
      15,     0,     0,    15,     0,     0,     0,     0,    15,    10,
      11,     0,     0,    12
};
...
{
       8,     3,    10,    12,    11,    17,     2,     3,    10,    22,
      23,     3,     4,    26,     5,    13,    28,    14,    29,    19,
       6,    15,     3,    38,    20,    11,    16,    32,    33,     3,
      10,    21,    40,     3,    10,    39,    43,    41,    25,     3,
      10,    44,    48,    27,    47,    49,    30,    31,    34,    35,
      52,    36,     6,    42,     0,    45,    37,    46,     0,     0,
      50,    51,     0,    53
};

static const yytype_int8 yycheck[] =
{
       1,     5,     6,     4,     8,    10,     0,     5,     6,    10,
       8,     5,     6,    14,     8,     5,    17,     7,    15,    12,
      14,    11,     5,     6,    12,     8,    16,    28,    29,     5,
       6,    12,     8,     5,     6,    36,     8,    38,    12,     5,
       6,    42,     8,     8,    45,    46,     5,    17,    12,     7,
      51,     4,    14,    16,    -1,    16,    35,    17,    -1,    -1,
      17,    16,    -1,    17
};
...
{
       0,    19,     0,     5,     6,     8,    14,    21,    22,    23,
       6,     8,    22,     5,     7,    11,    16,    10,    20,    12,
      12,    12,    22,     8,    22,    12,    22,     8,    22,    15,
       5,    17,    22,    22,    12,     7,     4,    21,     6,    22,
       8,    22,    16,     8,    22,    16,    17,    22,     8,    22,
      17,    16,    22,    17
};
...
#line 58 "gramatica.y" /* yacc.c:1646  */
    {avaliar_funcao((yyvsp[-2].str), (yyvsp[-1].str));}
#line 1311 "y.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 59 "gramatica.y" /* yacc.c:1646  */
    {aplicar_expressao_funcao((yyvsp[-4].valor),(yyvsp[-3].str),(yyvsp[-2].str),(yyvsp[-1].str));}
#line 1317 "y.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 63 "gramatica.y" /* yacc.c:1646  */
    {(yyval.str) = eval_cond((yyvsp[-2].valor),(yyvsp[-1].str), (yyvsp[0].str));}
#line 1323 "y.tab.c" /* yacc.c:1646  */
    break;

  case 9:
#line 66 "gramatica.y" /* yacc.c:1646  */
    {(yyval.str) = eval_op((yyvsp[-4].str), (yyvsp[-2].str), (yyvsp[0].str));}
#line 1329 "y.tab.c" /* yacc.c:1646  */
    break;

  case 10:
#line 68 "gramatica.y" /* yacc.c:1646  */
    {(yyval.str) = eval_op1((yyvsp[-9].str), (yyvsp[-7].str), (yyvsp[-5].valor), (yyvsp[-4].str), (yyvsp[-2].str),(yyvsp[0].str));}
#line 1335 "y.tab.c" /* yacc.c:1646  */
    break;

  case 11:
#line 70 "gramatica.y" /* yacc.c:1646  */
    {(yyval.str) = eval_op1((yyvsp[-9].str), (yyvsp[-7].str), (yyvsp[-5].valor), (yyvsp[-3].str), (yyvsp[-1].str),(yyvsp[-4].str));}
#line 1341 "y.tab.c" /* yacc.c:1646  */
    break;

  case 12:
#line 72 "gramatica.y" /* yacc.c:1646  */
    {(yyval.str) = eval_op2((yyvsp[-12].str), (yyvsp[-10].str), (yyvsp[-8].valor), (yyvsp[-7].str), (yyvsp[-5].str), (yyvsp[-3].str), (yyvsp[-1].str));}
#line 1347 "y.tab.c" /* yacc.c:1646  */
    break;

  case 13:
#line 75 "gramatica.y" /* yacc.c:1646  */
    {(yyval.str) = salvar_expr((yyvsp[-2].valor), (yyvsp[-1].str),(yyvsp[0].str));}
#line 1353 "y.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 76 "gramatica.y" /* yacc.c:1646  */
    {(yyval.str) = salvar_numero((yyvsp[0].str));}
...
#line 84 "gramatica.y" /* yacc.c:1906  */
